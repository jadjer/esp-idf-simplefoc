...
//#include <foc/common/defaults.h>
//#include <foc/common/foc_utils.h>
//#include <foc/common/time_utils.h>
 ...
 */
class BLDCMotor : public BaseMotor {
public:
  using Driver = std::unique_ptr<interface::BLDCDriver>;
...
public:
  /**
     ...
     */
  explicit BLDCMotor(std::uint8_t pp, float R = NOT_SET, float KV = NOT_SET, float L = NOT_SET);
  ~BLDCMotor() override = default;
...
public:
   ...
   */
  virtual void linkDriver(Driver driver);
